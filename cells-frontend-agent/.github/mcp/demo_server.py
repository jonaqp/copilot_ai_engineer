...
mcp = FastMCP("frontend-context-demo")
...
def get_agent_context(topic: str) -> dict:
    ...
    return {"topic": topic, "domain": 'Cells/frontend', "source": "demo-local", "warning": "No enterprise data is exposed by this demo MCP server."}

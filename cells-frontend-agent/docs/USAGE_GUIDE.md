# Guía de uso - Cells / Frontend Agent
...
Seleccionar `Cells / Frontend Agent` en Copilot Agent mode. Ejemplos:

- `Crea o modifica un componente frontend siguiendo la arquitectura existente.`
- `Revisa este PR de frontend priorizando accesibilidad y regresiones.`
- `Genera pruebas para el componente y explica los huecos de cobertura.`

...
Reemplazar el MCP demo por conectores autorizados. Para APX Development Agent, la prioridad sería: github, apx-context-demo. Separar credenciales por entorno, limitar toolsets y auditar acciones de escritura.

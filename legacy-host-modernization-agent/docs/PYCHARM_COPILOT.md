# PyCharm + GitHub Copilot - Legacy / Host Modernization Agent
...
4. Seleccionar `.github/agents/legacy-host-modernization.agent.md`.
5. Verificar que el modelo sea **Claude Opus 5** o únicamente otra opción Claude aprobada.

...
mcp = FastMCP("release-context-demo")
...
def get_agent_context(topic: str) -> dict:
    ...
    return {"topic": topic, "domain": 'release/production', "source": "demo-local", "warning": "No enterprise data is exposed by this demo MCP server."}

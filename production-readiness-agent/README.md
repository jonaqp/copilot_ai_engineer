...
Asistente de preparación a producción para revisar CRQs, evidencias, riesgos, rollback, dependencias y readiness de despliegue.

## Qué incluye

- Aplicación demo Flask (`app.py`) con UI y endpoint `POST /api/agent-plan`.
- Perfil GitHub Copilot en `.github/agents/production-readiness-agent.agent.md`.
...
4. Seleccionar **Production Readiness Agent** y pedir una tarea concreta.

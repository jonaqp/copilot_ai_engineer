...
Reemplazar el MCP demo por conectores autorizados. Para Production Readiness Agent, la prioridad sería: github, release-context-demo. Separar credenciales por entorno, limitar toolsets y auditar acciones de escritura.

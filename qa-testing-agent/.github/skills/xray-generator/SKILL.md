---
name: xray-generator
description: "Generar especificaciones de Test y Test Execution para Xray a partir de criterios de aceptacion, incluyendo pasos, resultados esperados y placeholders de evidencia por fuente. Usar para preparar casos Xray antes de publicarlos."
---
...
1. Transformar criterios de aceptacion en casos observables.
2. Ejecutar `scripts/generate_xray.py`.
3. Completar expected result y evidencia por fuente.
4. Revisar plantilla Xray vigente; publicar solo con aprobacion.

## Script ejecutable

Ejecutar `python scripts/generate_xray.py --help` para ver parametros. Usar el script para la parte determinista y dejar al modelo la interpretacion, priorizacion y redaccion.

...
SCENARIOS = [
    ...
    ("subagentStop", {"sessionId": "demo-1", "timestamp": 8, "cwd": str(ROOT), "agentName": "code-review", "agentId": "a1", "agentType": "custom", "response": "PASS: code is clear", "stopReason": "end_turn", "transcriptPath": "demo"}),

# Guía de uso - Jira / Workflow Automation Agent
...
Seleccionar `Jira / Workflow Automation Agent` en Copilot Agent mode. Ejemplos:

- `Convierte estas notas en un ticket Jira completo con criterios de aceptación.`
- `Clasifica y prioriza estos tickets y propone el siguiente paso.`
- `Valida este CRQ/ticket y señala campos o evidencias faltantes.`

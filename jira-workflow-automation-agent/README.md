# Jira / Workflow Automation Agent

Asistente para clasificar, redactar, validar y enrutar tickets y flujos de trabajo con controles de aprobación y trazabilidad.

## Qué incluye

- Aplicación demo Flask (`app.py`) con UI y endpoint `POST /api/agent-plan`.
- Perfil GitHub Copilot en `.github/agents/jira-workflow-automation-agent.agent.md`.
...
4. Seleccionar **Jira / Workflow Automation Agent** y pedir una tarea concreta.

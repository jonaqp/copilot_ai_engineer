...
Reemplazar el MCP demo por conectores autorizados. Para Jira / Workflow Automation Agent, la prioridad sería: github, jira-demo. Separar credenciales por entorno, limitar toolsets y auditar acciones de escritura.
